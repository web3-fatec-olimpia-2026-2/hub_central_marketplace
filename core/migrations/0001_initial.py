# Generated by Django 6.1 on 2026-08-31 04:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meli_client_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Mercado Livre Client ID')),
                ('meli_client_secret', models.CharField(blank=True, max_length=100, null=True, verbose_name='Mercado Livre Client Secret')),
                ('meli_access_token', models.TextField(blank=True, null=True, verbose_name='Mercado Livre Access Token')),
                ('meli_refresh_token', models.TextField(blank=True, null=True, verbose_name='Mercado Livre Refresh Token')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_em', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('atualizado_em', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
                ('loja', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarios', to='core.loja', verbose_name='Loja (Tenant)')),
